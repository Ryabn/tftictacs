...
const unitSplashLink = 'http://ddragon.leagueoflegends.com/cdn/img/champion/loading/Aatrox_0.jpg';
const units = [
    {
        name: 'Fiora',
        id: 0,
        icon: `${unitIconLink}Fiora.png`,
        splash: `${unitSplashLink}Fiora_0.png`,
        cost: 1,
        origin: ['Noble'],
        class: ['Blademaster'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Graves_0.png`,
        cost: 1,
        origin: ['Pirate'],
        class: ['Gunslinger'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Kassadin_0.png`,
        cost: 1,
        origin: ['Void'],
        class: ['Sorcerer'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Khazix_0.png`,
        cost: 1,
        origin: ['Void'],
        class: [ 0 ],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Mordekaiser_0.png`,
        cost: 1,
        origin: ['Phantom'],
        class: ['Knight'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Nidalee_0.png`,
        cost: 1,
        origin: ['Wild'],
        class: ['Shapeshifter'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Tristana_0.png`,
        cost: 1,
        origin: ['Yordle'],
        class: ['Gunslinger'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Vayne_0.png`,
        cost: 1,
        origin: ['Noble'],
        class: ['Ranger'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Warwick_0.png`,
        cost: 1,
        origin: ['Wild'],
        class: [ 2 ],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Darius_0.png`,
        cost: 1,
        origin: ['Imperial'],
        class: ['Knight'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Ahri_0.png`,
        cost: 2,
        origin: ['Wild'],
        class: ['Sorcerer'], 
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Blitzcrank_0.png`,
        cost: 2,
        origin: ['Robot'],
        class: [ 2 ],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Braum_0.png`,
        cost: 2,
        origin: ['Glacial'],
        class: ['Guardian'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Elise_0.png`,
        cost: 2,
        origin: ['Demon'],
        class: ['Shapeshifter'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Lissandra_0.png`,
        cost: 2,
        origin: ['Glacial'],
        class: ['Elementalist'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Lucian_0.png`,
        cost: 2,
        origin: ['Noble'],
        class: ['Gunslinger'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Lulu_0.png`,
        cost: 2,
        origin: ['Yordle'],
        class: ['Sorcerer'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Pyke_0.png`,
        cost: 2,
        origin: ['Pirate'],
        class: [ 0 ],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Reksai_0.png`,
        cost: 2,
        origin: ['Void'],
        class: [ 2 ],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Shen_0.png`,
        cost: 2,
        origin: ['Ninja'],
        class: [ 1 ],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Varus_0.png`,
        cost: 2,
        origin: ['Demon'],
        class: ['Ranger'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Zed_0.png`,
        cost: 2,
        origin: ['Ninja'],
        class: [ 0 ],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Aatrox_0.png`,
        cost: 3,
        origin: ['Demon'],
        class: [ 1 ],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Ashe_0.png`,
        cost: 3,
        origin: ['Glacial'],
        class: ['Ranger'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Chogath_0.png`,
        cost: 3,
        origin: ['Void'],
        class: ['Brawler'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Evelynn_0.png`,
        cost: 3,
        origin: ['Demon'],
        class: [ 0 ],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Gangplank_0.png`,
        cost: 3,
        origin: ['Pirate'],
        class: ['Gunslinger'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Katarina_0.png`,
        cost: 3,
        origin: ['Imperial'],
        class: ['Assassin'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Kennen_0.png`,
        cost: 3,
        origin: ['Ninja', 'Yordle'],
        class: ['Elementalist'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Morgana_0.png`,
        cost: 3,  
        origin: ['Demon'],
        class: ['Sorcerer'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Poppy_0.png`,
        cost: 3,    
        origin: ['Yordle'],
        class: ['Knight'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Rengar_0.png`,
        cost: 3,    
        origin: ['Wild'],
        class: [ 0 ],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Shyvana_0.png`,
        cost: 3,
        origin: ['Dragon'],
        class: ['Shapeshifter'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Veigar_0.png`,
        cost: 3,    
        origin: ['Yordle'],
        class: ['Sorcerer'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Volibear_0.png`,
        cost: 3,    
        origin: ['Glacial'],
        class: [ 2 ],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Akali_0.png`,
        cost: 4,    
        origin: ['Ninja'],
        class: [ 1 ],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}AurelionSol_0.png`,
        cost: 4,  
        origin: ['Dragon'],
        class: ['Sorcerer'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Brand_0.png`,
        cost: 4,  
        origin: ['Demon'],
        class: ['Elementalist'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Draven_0.png`,
        cost: 4,
        origin: ['Imperial'],
        class: [ 1 ],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Gnar_0.png`,
        cost: 4,
        origin: ['Wild', 'Yordle'],
        class: ['Shapeshifter'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Kindred_0.png`,
        cost: 4,
        origin: ['Phantom'],
        class: ['Ranger'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Leona_0.png`,
        cost: 4,
        origin: ['Noble'],
        class: ['Knight'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Sejuani_0.png`,
        cost: 4,
        origin: ['Glacial'],
        class: ['Knight'],
    ...
    },
    {
        name: 'Anivia',
        id: 43,
        icon: `${unitIconLink}.png`,
        splash: `${unitSplashLink}_0.png`,
        cost: 5,
        origin: ['Glacial'],
        class: ['Elementalist'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Karthus_0.png`,
        cost: 5,
        origin: ['Phantom'],
        class: ['Sorcerer'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Kayle_0.png`,
        cost: 5,
        origin: ['Noble'],
        class: ['Knight'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}MissFortune_0.png`,
        cost: 5,
        origin: ['Pirate'],
        class: ['Gunslinger'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Swain_0.png`,
        cost: 5,
        origin: ['Imperial'],
        class: ['Shapeshifter'],
    ...
    },
    {
        ...
        splash: `${unitSplashLink}Yasuo_0.png`,
        cost: 5,
        origin: ['Exile'],
        class: [ 1 ],
